...
const values = [
  {
    letter: "V",
    word: "Vision",
    description: "We see beyond the present, constantly innovating and pushing boundaries to shape the future of technology in Africa.",
    icon: Eye,
    color: "bg-blue-500"
  },
  {
    letter: "I",
    word: "Integrity",
    description: "We operate with transparency, honesty, and ethical practices in everything we do, building trust with our clients and students.",
    icon: Heart,
    color: "bg-green-500"
  },
  {
    letter: "E",
    word: "Excellence",
    description: "We pursue the highest standards in our work, never settling for mediocrity in our solutions or training programs.",
    icon: Award,
    color: "bg-amber-500"
  },
  {
    letter: "K",
    word: "Knowledge",
    description: "We believe in continuous learning and sharing knowledge to empower individuals and transform communities.",
    icon: Lightbulb,
    color: "bg-purple-500"
  }
]
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <p className="text-xl text-gray-600 mb-8 leading-relaxed">
              Viek Technologies is a dual-purpose tech hub and academy dedicated to building 
              purposeful digital solutions for businesses while training the next generation 
              of tech talent across Africa and beyond.
            </p>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <div className="space-y-4 text-gray-600 leading-relaxed">
                ...
                <p>
                  What started as a small training initiative in Lagos has grown into a comprehensive 
                  tech hub serving clients across multiple continents and training hundreds of developers 
                ...
                <p>
                  Today, we continue to innovate, expand our reach, and remain committed to our core 
                  belief that technology, when used purposefully, can transform lives and communities.
                </p>
              </div>
            </motion.div>
            <motion.div
              ...
              <Card className="h-full bg-white border-0 shadow-lg hover:shadow-xl transition-shadow">
                <CardContent className="p-8">
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    To deliver innovative, purpose-driven digital solutions that empower businesses 
                    to thrive in the digital age, while nurturing and developing tech talent through 
                    comprehensive, industry-aligned training programs that prepare individuals for 
                    successful careers in technology.
                  </p>
                  <ul className="mt-6 space-y-3">
                    {["Deliver excellence in every project", "Train job-ready developers", "Bridge the tech skills gap", "Foster innovation and creativity"].map((item, i) => (
              ...
              <Card className="h-full bg-gradient-to-br from-blue-600 to-indigo-700 border-0 shadow-lg hover:shadow-xl transition-shadow">
                <CardContent className="p-8">
                  ...
                  <p className="text-blue-100 leading-relaxed">
                    To become Africa&apos;s leading technology solutions provider and training 
                    institution, recognized globally for excellence in software development, 
                    innovation, and producing world-class tech professionals who drive digital 
                    transformation across industries.
                  </p>
                  <ul className="mt-6 space-y-3">
                    {["Lead tech innovation in Africa", "Global recognition for excellence", "Shape the future of tech education", "Create lasting impact through technology"].map((item, i) => (
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Our name embodies our principles. Each letter represents a value that guides everything we do.
            </p>
          </motion.div>
              ...
              >
                <Card className="h-full bg-white border border-gray-100 shadow-lg hover:shadow-xl transition-all hover:-translate-y-1">
                  <CardContent className="p-6 text-center">
                    <div className={`w-20 h-20 ${value.color} rounded-2xl flex items-center justify-center mx-auto mb-4`}>
                      <span className="text-4xl font-bold text-white">{value.letter}</span>
                    </div>
                    <h3 className="text-xl font-bold text-gray-900 mb-2">{value.word}</h3>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-blue-200 max-w-2xl mx-auto">
              From humble beginnings to becoming a leading tech institution, every step has shaped who we are.
            </p>
          </motion.div>
      ...
      {/* <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              The People Behind Viek Tech
            </h2>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              A passionate team of innovators, educators, and technologists dedicated to excellence.
            </p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {teamMembers.map((member, index) => (
              <motion.div
                ...
                transition={{ delay: index * 0.1 }}
              >
                <Card className="h-full bg-white border-0 shadow-lg hover:shadow-xl transition-all group overflow-hidden">
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-blue-100 mb-8">
              Whether you need a digital solution for your business or want to start your tech career, 
