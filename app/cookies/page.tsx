...
export const metadata = {
  ...
  description:
    "Learn how Viek Technologies uses cookies and similar technologies on our website.",
};
  ...
  const cookieTypes = [
    {
      ...
      description:
        "These cookies are essential for the website to function properly. They enable basic functions like page navigation, access to secure areas, and remembering your preferences. The website cannot function properly without these cookies.",
      examples: [
        "Session cookies",
    ...
    },
    {
      ...
      description:
        "These cookies enable enhanced functionality and personalization, such as remembering your preferences and settings. They may be set by us or third-party providers.",
      examples: [
          ...
          <div className="prose prose-gray max-w-none">
            <section className="mb-8">
              ...
              <p className="text-muted-foreground leading-relaxed mb-4">
                ...
                provide a better user experience, as well as to provide
                information to the website owners.
              </p>
              <p className="text-muted-foreground leading-relaxed">
                We use cookies and similar tracking technologies to enhance your
                browsing experience, analyze website traffic, personalize
                content, and serve targeted advertisements.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground leading-relaxed mt-4">
                These third parties may combine information collected from our
                website with other information they have collected from other
                websites.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc list-inside text-muted-foreground space-y-2">
                <li>
                  ...
                  our website, you can accept all cookies, reject non-essential
                  cookies, or customize your preferences.
                </li>
                <li>
                  <strong>Browser Settings:</strong> Most web browsers allow you
                  to control cookies through their settings. You can usually
                  find these in the &quot;Options&quot; or
                  &quot;Preferences&quot; menu.
                </li>
                <li>
                  <strong>Opt-Out Tools:</strong> Some third parties provide
                  opt-out tools for their cookies and tracking technologies.
                </li>
              </ul>
              <p className="text-muted-foreground leading-relaxed mt-4">
                Please note that blocking or deleting cookies may affect your
                experience on our website and limit the functionality of certain
                features.
              </p>
            </section>
