...
export const metadata = {
  ...
  description:
    "Learn how Viek Technologies collects, uses, and protects your personal information.",
};
          ...
          <div className="prose prose-gray max-w-none">
            <section className="mb-8">
              ...
              <p className="text-muted-foreground leading-relaxed mb-4">
                Welcome to Viek Technologies (&quot;Viek Tech,&quot;
                &quot;we,&quot; &quot;us,&quot; or &quot;our&quot;). We are
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc list-inside text-muted-foreground space-y-2">
                ...
                <li>
                  <strong>Business Partners:</strong> With partners for specific
                  programs or services you enroll in
                </li>
                <li>
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                track information about your browsing activity. For more
