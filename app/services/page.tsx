...
const services = [
  {
    ...
    fullDesc:
      "We build high-performance, scalable web applications using the latest technologies including React, Next.js, Node.js, and more. Our solutions are designed to grow with your business.",
    features: [
  ...
  },
  {
    ...
    fullDesc:
      "Create powerful mobile experiences that your users will love. We develop native and cross-platform apps that deliver exceptional performance and user experience.",
    features: [
      "iOS App Development",
  ...
  },
  {
    ...
    fullDesc:
      "Our design team creates intuitive, beautiful interfaces that delight users and drive conversions. We focus on user research, prototyping, and iterative design.",
    features: [
  ...
  },
  {
    ...
    fullDesc:
      "Leverage the power of cloud computing with our comprehensive cloud solutions. We help businesses migrate, optimize, and manage their cloud infrastructure.",
    features: [
      "Cloud Migration",
  ...
  },
  {
    ...
    fullDesc:
      "In today's digital landscape, security is paramount. Our cybersecurity services help protect your business from threats and ensure compliance with industry standards.",
    features: [
      "Security Audits",
      "Penetration Testing",
  ...
  },
  {
    ...
    fullDesc:
      "Unlock the value in your data with our analytics services. We help businesses collect, process, and analyze data to drive informed decision-making.",
    features: [
    ...
    image: "/images/data_analytics.jpeg",
  },
];
...
const process = [
  ...
  },
  {
    ...
    title: "Planning",
    description:
      "Our team creates a detailed project plan, including timeline, milestones, and deliverables.",
  },
  {
    step: "03",
    title: "Design",
    description:
      "We design intuitive user interfaces and create prototypes for your approval.",
  },
  {
    step: "04",
    title: "Development",
    description:
      "Our developers build your solution using agile methodology with regular updates.",
  },
  {
    step: "05",
    title: "Testing",
    description:
      "Rigorous quality assurance ensures your product is bug-free and performs optimally.",
  },
  {
    step: "06",
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <p className="text-xl text-gray-600 mb-8 leading-relaxed">
              From web development to cybersecurity, we offer end-to-end
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              We provide a full spectrum of technology services to meet your
              business needs.
            </p>
          </motion.div>
