      ...
      <div className="container mx-auto px-4 py-12 lg:py-20">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <motion.div
            ...
            className="space-y-8"
          >
            <Badge variant="secondary" className="px-4 py-1.5 text-xs font-medium bg-primary/10 text-primary border-primary/20">
              {content.hero.badge}
            </Badge>
            ...
            <div className="relative aspect-square max-w-lg mx-auto">
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-foreground">{content.stats.projects}</p>
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-foreground">{content.stats.students}</p>
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-foreground">{content.stats.successRate}</p>
